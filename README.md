...
- This puzzle was designed in TinkerCAD. It features several square pieces that fit into the base, each piece is half the size of another piece. The size of the pieces are based on the geometric series $\sum_{n=0}^{\infty} \left(\frac{1}{2}\right)^n$ 
